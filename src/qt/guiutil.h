...
/** Utility functions used by the MagnaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MagnaCoin addresses in monospace font
...
// Parse "mgn:" URI into recipient object, return true on successful parsing
