...
/** Utility functions used by the KackCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render KackCoin addresses in monospace font
...
// Parse "kck:" URI into recipient object, return true on successful parsing
