                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KackCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KackCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kck: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KackCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about KackCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KackCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KackCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KackCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a KackCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KackCoin Core help message to get a list with possible KackCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KackCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KackCoin network", "", count));
}
...
{
    QString strTitle = tr("KackCoin Core"); // default title
