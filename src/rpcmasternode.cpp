...
Value obfuscation(const Array& params, bool fHelp)
{
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <kckaddress> <amount>\n"
            "kckaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <kckaddress> <amount>\n"
            "kckaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in kck.conf\n"
...
Value masternodelist(const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1)) {
        throw runtime_error(
            ...
            "    \"addr\": \"addr\",      (string) Masternode KackCoin address\n"
