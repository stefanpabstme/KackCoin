...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mgn_address\> \<monthly_payment_mgn\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MGN, _12_ times over the course of a year totaling _24000_ MGN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mgn_address\> \<monthly_payment_mgn\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MGN.
