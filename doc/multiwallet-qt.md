...
In order to support loading of multiple wallets in kck-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kck.cpp.
...
Changes to kck.cpp
----------------------
kck.cpp is the entry point into kck-qt, and as such, will require some minor modifications to provide hooks for
