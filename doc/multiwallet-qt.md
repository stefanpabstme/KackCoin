...
In order to support loading of multiple wallets in mgn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mgn.cpp.
...
Changes to mgn.cpp
----------------------
mgn.cpp is the entry point into mgn-qt, and as such, will require some minor modifications to provide hooks for
